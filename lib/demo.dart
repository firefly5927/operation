      ...
      body: Center(
        child: StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<int> snapshot) {
              return Text('you click ${snapshot.data} times');
            }),
      ),
      floatingActionButton: FloatingActionButton(
          child: Icon(Icons.add),
          onPressed: () {
            bloc.incrementSink.add(null);
          }),
    );
  }
}
...
class IncrementBloc implements BlocBase {
  ...
  Stream<int> get outCounter => _controller.stream;

  ///业务处理的stream
  StreamController _actionController = StreamController();

  StreamSink get incrementSink => _actionController.sink;

  IncrementBloc() {
    _counter = 0;
    _actionController.stream.listen(_add);
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: StreamBuilder<int>(
          builder: (BuildContext context, AsyncSnapshot<int> snapshot) {
            return Text('click: ${snapshot.data} times');
          },
